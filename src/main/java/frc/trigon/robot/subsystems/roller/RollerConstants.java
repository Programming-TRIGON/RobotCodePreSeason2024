...
public class RollerConstants {
    ...
    static final MechanismRoot2d ROLLER_ANGLE_ROOT = ROLLER_ANGLE_MECHANISM.getRoot(
            "ZRollerRoot",
            ROLLER_MECHANISM_ROOT_X,
            ROLLER_MECHANISM_ROOT_Y);
    static final MechanismLigament2d ROLLER_ANGLE_LIGAMENT = ROLLER_ANGLE_ROOT.append(new MechanismLigament2d(
            "RollerLigament",
            ROLLER_LENGTH_METERS,
            0,
            LIGAMENT_LINE_WIDTH,
