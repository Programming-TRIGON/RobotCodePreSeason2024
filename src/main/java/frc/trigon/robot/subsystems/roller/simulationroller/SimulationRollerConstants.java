...
public class SimulationRollerConstants {
    ...
    private static final double ANGLE_GEAR_RATIO = 8.4;
    ...
    private static final int COLLECTOR_MOTOR_AMOUNT = 1;
    private static final DCMotor COLLECTOR_MOTOR_GEARBOX = DCMotor.getNEO(COLLECTOR_MOTOR_AMOUNT);
    private static final double COLLECTOR_GEAR_RATIO = 23452234.1;
