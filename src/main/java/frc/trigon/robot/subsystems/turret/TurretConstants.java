...
public class TurretConstants {
    ...
    private static final MechanismRoot2d TURRET_ROOT = TURRET_MECHANISM.getRoot("TURRET_ROOT", TURRET_ROOT_X, TURRET_ROOT_Y);
    static final MechanismLigament2d TURRET_LIGAMENT = TURRET_ROOT.append(new MechanismLigament2d("TURRET_LIGAMENT", 0, 0, MECHANISM_LINE_WIDTH, new Color8Bit(Color.kBlue)));
}
